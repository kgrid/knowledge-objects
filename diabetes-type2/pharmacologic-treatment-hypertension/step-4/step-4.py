...
def therapyRecommendation4(inputs):
...
def test():
    if therapyRecommendation4({"systolic":0,"diastolic":0}) != "No systolic or diastolic information provided. Cannot calculate.":
        return "error."
    if therapyRecommendation4({"systolic":10,"diastolic":0}) != "Not applicable, patient doesn't have high blood pressure.":
        return "error."
    if therapyRecommendation4({"systolic":150,"diastolic":90}) != ("If above agents are contraindicated or dose is optimized and patient BP remains >= 140/90" + "\n" + "Add a Beta-Blocker to the first two agents. Initiate therapy with either metoprolol (preferred) or atenolol:" + "\n" + "(a) Metroprolol tartate 25 to 50mg BID. Titrate by doubling dose every 2-4 weeks until BP goal met (max dose: 200mg)" + "\n" + "(b) Atenolol 25mg daily. Titrate by doubling dose every 2-4 weeks until BP goal met (max dose: 100mg)"):
        return "error."
    if therapyRecommendation4({"systolic":0,"diastolic":110}) !=  ("If above agents are contraindicated or dose is optimized and patient BP remains >= 140/90" + "\n" + "Add a Beta-Blocker to the first two agents. Initiate therapy with either metoprolol (preferred) or atenolol:" + "\n" + "(a) Metroprolol tartate 25 to 50mg BID. Titrate by doubling dose every 2-4 weeks until BP goal met (max dose: 200mg)" + "\n" + "(b) Atenolol 25mg daily. Titrate by doubling dose every 2-4 weeks until BP goal met (max dose: 100mg)"):
        return "error."
    return "ok."
